      ...
      if (params.srcL2Id == 0)
        {
          ...
          m_miUlHarqProcessesPacket.at (m_harqProcessId)->AddPacket (params.pdu); //Lokesh This is cofof
      ...
      if (m_schedulingGrantMetric == LteUeMac::SlSchedulingGrantMetric::FIXED)
        {
          ...
          NS_LOG_DEBUG ("<MCS, PRBs>= <" << (uint16_t)grant.m_mcs << ", " << (uint16_t)grant.m_rbLen << ">, TBS= " << grant.m_tbSize);
        }
      else
                ...
                case LteUeMac::SlSchedulingGrantMetric::MIN_PRB:
                  ...
                  */
                  ...
                  for (; ritPair != kMcsPrbPairList.rend (); ritPair++)
                    ...
                    std::cout << "<MCS, PRBs>= <" << (uint16_t)grant.m_mcs << ", " << (uint16_t)grant.m_rbLen << ">, TBS= " << grant.m_tbSize <<std::endl;
                  NS_LOG_DEBUG ("<MCS, PRBs>= <" << (uint16_t)grant.m_mcs << ", " << (uint16_t)grant.m_rbLen << ">, TBS= " << grant.m_tbSize);
                  break;
